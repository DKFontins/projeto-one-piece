...
OBJETIVO 1 - quando clicar no botão do personagem na lista, marcar o botao como selecionado 
    ...
    //document.getElementById('chopper; zoro; luffy; etc')
...
/*OBJETIVO 1 - passo 3 (caso o passo 2 não estive selecionado) - verificar se já existe um botão selecionado, se sim, devemos remover a seleção dele
function desselecionarBotao() {
    const botaoSelecionado = document.querySelector(".botao.selecionado");
    botaoSelecionado.classList.remove("selecionado")
}
/*OBJETIVO 2 - passo 3 (caso o passo 2 não estive selecionado) - verificar se já existe um personagem selecionado, se sim, devemos remover a seleção dele
